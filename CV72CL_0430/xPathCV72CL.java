...
public class xPathCV72CL {

    public static void main(String[] args) {
        try {
            String CV72CL = "CV72CL";

            DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
            DocumentBuilder builder = factory.newDocumentBuilder();
            Document document = builder.parse(new File("studentCV72CL.xml"));
            ...
            StreamResult result = new StreamResult(new File("studentCV72CL1.xml"));
            transformer.transform(source, result);

            System.out.println("\nAz eredmény kiírva a studentCV72CL1.xml fájlba.");
